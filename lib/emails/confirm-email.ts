...
export function renderConfirmEmail(confirmToken: string, unsubscribeToken: string): string {
  ...
  const body = `
    ...
    <p style="margin:24px 0;">
      <a href="${url}" style="background:#1e222a;color:#f6f5f1;padding:12px 24px;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:14px;letter-spacing:1px;">CONFIRM SUBSCRIPTION</a>
    </p>
    <p style="margin:0 0 14px;color:#8a8578;font-size:14px;">If you didn't sign up, ignore this
